...
`);
		...
		function apply(ctx) {
			...
			slots.inject("settings.section", () => slots.register(
				{ name: "settings.section", id: "srv-fs-settings", order: 50, label: "远程工作区" },
			...
			slots.inject("sidebar.footer.action", () => slots.register(
				{ name: "sidebar.footer.action", id: "cordis-panel", order: 0, label: "插件管理" },
				() => null
			));
			...
			slots.inject("shell.overlay", () => slots.register(
				{ name: "shell.overlay", id: "srv-fs-float", order: 20 },
